---
title: NextJS Notes
description: React Notes 是一个基于 Next.js 构建的简洁笔记管理应用，专注于 Markdown 编辑体验。这是一个甜品级的学习 Demo，用于实践 Next.js App Router、React Server Components 和现代 Web 开发技术栈。
heroImage: "./_images/image.webp"
heroAlt: NextJS Notes 应用界面
publishDate: 2024-12-19
tags: ["next.js", "react", "redis"]
---
