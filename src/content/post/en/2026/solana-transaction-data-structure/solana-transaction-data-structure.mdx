...
translationKey: solana-transaction-data-structure
...
> 如果你对 Anchor Event 的底层实现感兴趣，可以阅读 [Anchor Event 与 Self‑CPI：Solana 事件机制的深层设计](/en/blog/2026/anchor-event-self-cpi-in-solana)。
